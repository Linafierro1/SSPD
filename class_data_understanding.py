...
def main() -> None:
    ...
    # Plots
    # Escribe en el log que se va a iniciar la generación de gráficos exploratorios
    logger.info("Generando gráficos...")
    # Genera y guarda un gráfico de barras con el conteo de valores faltantes por columna
    plot_missing_bar(df_cols_norm, "reports/figures/missing_bar.png")
    # Genera histogramas para las columnas numéricas (hasta el máximo indicado por el usuario) y los guarda en la carpeta figures
    plot_histograms(df_cols_norm, "reports/figures", max_cols=args.max_hist)
    # Genera diagramas de caja (boxplots) para las columnas numéricas (hasta el máximo indicado) y los guarda en la carpeta figures
    plot_boxplots(df_cols_norm, "reports/figures", max_cols=args.max_box)
    # Calcula y grafica la matriz de correlación entre variables numéricas, guardando el resultado como imagen
